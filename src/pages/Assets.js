...
import { fetchAssets, addAsset, updateAsset, deleteAsset } from "../pages/apicall/api";

const Assets = ({ setAuth }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
            ...
            <button onClick={() => setAuth(false)} className="mt-6 btn btn-error w-full">
                Logout 🚪
            </button>
        </div>
    );
